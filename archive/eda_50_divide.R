...
for (i in 1:50){
  ...
  # divide sd
  mse.lm.X.class.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Yhat.lm.X.class.test[[ix]]-Y.test.list[[ix]]))^2))
  ...
  mse.lasso.X.class.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Yhat.lasso.X.class.test[[ix]]-Y.test.list[[ix]]))^2))
  ...
  mse.ridge.X.class.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Yhat.ridge.X.class.test[[ix]]-Y.test.list[[ix]]))^2))
  ...
  mse.lasso.U.class.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Y.test.list[[ix]] - Yhat.lasso.U.class[[ix]]))^2))
  ...
  mse.ridge.U.class.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Y.test.list[[ix]] - Yhat.ridge.U.class[[ix]]))^2))
  ...
  mse.lm.U.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Yhat.lm.U.test[[ix]]-Y.test.list[[ix]]))^2))
  mse.lm.U = sum(mse.U.class.vec*n.test.vec)/sum(n.test.vec)
  ...
  mse.lasso.U.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Yhat.lasso.U.test[[ix]]-Y.test.list[[ix]]))^2))
  corr.lasso.U.vec = sapply(1:3, function(ix) cor(Yhat.lasso.U.test[[ix]],Y.test.list[[ix]]))
  ...
  mse.ridge.U.vec = sapply(1:3, function(ix) mean((Y.train.sd[[ix]]*(Yhat.ridge.U.test[[ix]]-Y.test.list[[ix]]))^2))
  corr.ridge.U.vec = sapply(1:3, function(ix) cor(Yhat.ridge.U.test[[ix]],Y.test.list[[ix]]))
  ...
  mse.lasso1 = c(mse.lasso.X, mse.lasso.U, mse.lasso.X.class, mse.lasso.U.class)
  mse.lm1 = c(mse.lm.X, mse.lm.U, mse.lm.X.class, mse.lm.U.class)
  ...
  mse.lm.vec1 = rbind(mse.lm.X.vec, mse.lm.X.class.vec, mse.lm.U.vec, mse.lm.U.class.vec, mse.mean.vec)
  mse.lasso.vec1 = rbind(mse.lasso.X.vec, mse.lasso.X.class.vec, mse.lasso.U.vec, mse.lasso.U.class.vec, mse.mean.vec)
  mse.ridge.vec1 = rbind(mse.ridge.X.vec, mse.ridge.X.class.vec, mse.ridge.U.vec, mse.ridge.U.class.vec, mse.mean.vec)
}
