...
for (s in seq(0, 6, by = 0.5)){
  ...
  for (ii in 1:50){
    ...
    X1 = generateX(n, p, K, spike = spike1, d, du = spike1[K]*rho, rrho = 0.1)$X
    X2 = generateX(n, p, K, spike = spike2, d, du = spike2[K]*rho, rrho = 0.1)$X
    X3 = generateX(n, p, K, spike = spike3, d, du = spike3[K]*rho, rrho = 0.1)$X
