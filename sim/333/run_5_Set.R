...
# fix sigma = 0.5, beta = 0
# 1, 2, 3, 4
setwd("/Users/MonicaW/Documents/GitHub/alpha/sim/333/1")
for (para in para_grid.list[1:4]){
  for (i in 1:50){
    n = 100
    p = para$p
    n_label = 3
    ...
    # beta_U = c(rep(0, 5), c(rep(0.5, 5), rep(0, p-10)))
...
#    F.train.list[[1]][,-1]%*%L.list[[1]]%*%matrix(ml.lm.U$coefficients[-1])
...
# fix sigma = 0.5, beta = 0.5
# 17 18 19 20
# beta_U = 0.5 same 
setwd("/Users/MonicaW/Documents/GitHub/alpha/sim/333/2")
for (para in para_grid.list[17:20]){
  for (i in 1:50){
    n = 100
    p = para$p
    n_label = 3
    ...
    sigma.vec = para$sigma.vec
    beta_U = c(c(rep(0.5, 5), rep(0, p-5)))
    # beta_U = c(rep(0, 5), c(rep(0.5, 5), rep(0, p-10)))
...
# 17 18 19 20
# beta_U = 0.5 diff 
setwd("/Users/MonicaW/Documents/GitHub/alpha/sim/333/3")
for (para in para_grid.list[17:20]){
  for (i in 1:50){
    n = 100
    p = para$p
...
# fix sigma = 0.5, beta = 2
# 17 18 19 20
# same 
setwd("/Users/MonicaW/Documents/GitHub/alpha/sim/333/4")
for (para in para_grid.list[17:20]){
  for (i in 1:50){
    n = 100
    p = para$p
...
# 17 18 19 20
# diff 
setwd("/Users/MonicaW/Documents/GitHub/alpha/sim/333/5")
for (para in para_grid.list[17:20]){
  for (i in 1:50){
    n = 100
    p = para$p
    ...
    sigma.vec = para$sigma.vec
    #beta_U = c(c(rep(para$beta, 5), rep(0, p-5)))
    beta_U = c(rep(0, 5), c(rep(2, 5), rep(0, p-10)))
